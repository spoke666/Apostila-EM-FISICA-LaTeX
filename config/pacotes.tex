...
% Define "Gráfico" como um elemento independente de "Figura"
...
% --- 9. LINKS, REFERÊNCIAS CRUZADAS E NUMERAÇÃO ---
\usepackage{hyperref}
\hypersetup{colorlinks=true, allcolors=blue, breaklinks=true}
\usepackage[brazilian]{cleveref}

% Configurações de numeração por capítulo
\numberwithin{equation}{chapter} 
\numberwithin{figure}{chapter}   
\numberwithin{table}{chapter}    
\numberwithin{grafico}{chapter}

% Formato na linha da equação: (Eq 4.1)
\renewcommand{\theequation}{Eq \thechapter.\arabic{equation}}

% Configurações do Cleveref para Equações
\crefname{equation}{}{}
\Crefname{equation}{}{}
\creflabelformat{equation}{#2Eq. \thechapter.\arabic{equation}#3}

% Configurações do Cleveref para Gráficos
\crefname{grafico}{Gráfico}{Gráficos}
\Crefname{grafico}{Gráfico}{Gráficos}

% Configuração para subgráficos (subfigures dentro de gráficos)
\crefname{subgrafico}{Gráfico}{Gráficos}
\Crefname{subgrafico}{Gráfico}{Gráficos}
\captionsetup[subgrafico]{labelformat=simple, labelsep=space}
\renewcommand\thesubgrafico{(\alph{subgrafico})}
