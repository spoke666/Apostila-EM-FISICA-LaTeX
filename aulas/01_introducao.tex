...
Na física, lidamos com dimensões que variam do átomo às galáxias. Utilizamos a notação científica:
\begin{equation}
    N \times 10^{n}, \quad \text{sendo } 1 \leq N < 10
\end{equation}
...
\begin{itemize}
    \item Se o número $N$ na notação científica $N \times 10^{n}$ for menor que $\sqrt{10}$, a ordem de grandeza é o expoente $n$.
    ...
    \item Se o número $N$ for maior ou igual a $\sqrt{10}$, a ordem de grandeza é o expoente $n + 1$.
