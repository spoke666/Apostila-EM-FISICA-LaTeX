...
\section{Exercícios Conceitual de Fixação}
...
\section{Exercícios de Fixação: MRU}

\begin{enumerate}[label=\textbf{Exercício \arabic*:}, leftmargin=*]
    ...
    \parencite{exemplo_grafico_2026}
...
\section{Problemas de Aplicação: MRU}

\begin{enumerate}[label=\textbf{Problema \arabic*:}, leftmargin=*]
